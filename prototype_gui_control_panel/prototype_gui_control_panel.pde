...
// plots
Graph BarChart = new Graph(225, 70, 300, 150, color(20, 20, 200));
Graph LineGraph = new Graph(225, 350, 300, 200, color (20, 20, 200));
...
void setup() {
  ...
  cp5.addToggle("imageStatus").setPosition(x,y=y+40).setValue(int(getPlotterConfigString("imageStatus"))).setMode(ControlP5.SWITCH).setSize(20,20);
}
...
void draw() {
  ...
  image(example_img, 600, 30, 600, 400);
  }
}
